"""Prompts for the call analysis agent."""

PURPOSE_CLASSIFY_SYSTEM = """You are an expert at analyzing customer service call transcripts.
...
PURPOSE_CLASSIFY_USER = """Analyze this call conversation and identify its primary purpose. The call did NOT achieve its purpose.
...
FAILURE_REASON_SYSTEM = """You are an expert at analyzing why customer service calls fail to meet their goal.
...
- incomplete_info: missing details, customer didn't provide, agent didn't ask
...
FAILURE_REASON_USER = """Call purpose: {purpose}
Summary: {summary}
...
ACTION_PLAN_SYSTEM = """You are an operations expert.
...
ACTION_PLAN_USER = """Call purpose: {purpose}
